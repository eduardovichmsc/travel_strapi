...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departsFrom: Schema.Attribute.String;
    ...
    gallery: Schema.Attribute.Media<
      ...
      true
    >;
    groupSize: Schema.Attribute.Decimal;
    highlights: Schema.Attribute.Component<'shared.list-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    minimumAge: Schema.Attribute.Decimal;
    price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    rating: Schema.Attribute.Decimal;
    reviews: Schema.Attribute.Decimal;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatIsIncluded: Schema.Attribute.Component<'shared.list-item', true>;
    whatToBring: Schema.Attribute.Component<'shared.list-item', true>;
  };
}
